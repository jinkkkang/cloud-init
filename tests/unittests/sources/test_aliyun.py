...
DEFAULT_METADATA_RAW = r"""{
  "disks": {
    "bp15spwwhlf8bbbn78d9": {
      "id": "d-bp15spwwhlf8bbbn78d9",
      "name": ""
    }
  },
  "dns-conf": {
    ...
    "interfaces": {
      "macs": {
        "00:16:3e:14:59:58": {
          ...
          "network-interface-id": "eni-bp13i3ed90icgdga0y7p"
        }
      }
    }
  },
...
class TestAliYunDatasource(test_helpers.ResponsesTestCase):
    ...
    def regist_default_server(self, register_whole_meta_path=True):
        self.register_mock_metaserver(self.metadata_url, self.default_metadata)
        if register_whole_meta_path:
    ...
    @mock.patch("cloudinit.sources.DataSourceEc2.util.is_resolvable")
    @mock.patch("cloudinit.sources.DataSourceAliYun._is_aliyun")
    def test_with_mock_server_without_all_path(self, m_is_aliyun, m_resolv):
        m_is_aliyun.return_value = True
        self.regist_default_server(register_whole_meta_path=False)
        ret = self.ds.get_data()
        self.assertEqual(True, ret)
        self.assertEqual(1, m_is_aliyun.call_count)
        self._test_get_data()
        ...
        netcfg = convert_ecs_metadata_network_config(
            {
                "interfaces": {
                    "macs": {
                        "00:16:3e:14:59:58": {
                            "ipv6-gateway": "2408:4005:3c7:2700:ffff:ffff:xxxxx",
                            "ipv6s": "[2408:4005:3c7:2700:7eea:f1fe:xxxxxx]",
